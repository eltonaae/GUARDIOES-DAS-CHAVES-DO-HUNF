...
export const LoginModal: React.FC<LoginModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-6 border border-slate-200 animate-in fade-in zoom-in-95 duration-150">
          ...
          <form onSubmit={handleCustomSubmit} className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full text-xs p-2.5 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-emerald-600"
              />
            </div>
            ...
            <div className="flex space-x-2 pt-2">
              <button
                ...
                className="w-1/2 py-2 text-xs font-medium text-slate-600 bg-slate-100 rounded-lg hover:bg-slate-200"
              >
                Voltar
              </button>
              <button
                type="submit"
                className="w-1/2 py-2 text-xs font-semibold text-white bg-emerald-700 rounded-lg hover:bg-emerald-800 shadow-sm flex items-center justify-center space-x-1"
              >
